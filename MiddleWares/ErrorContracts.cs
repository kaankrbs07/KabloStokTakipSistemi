...
public static class AppErrors
{
    public static class Common
    {
        ...
        public static readonly AppError Forbidden    = new("KSTS-0403", StatusCodes.Status403Forbidden);
        public static readonly AppError Conflict     = new("KSTS-0409", StatusCodes.Status409Conflict);
    }
