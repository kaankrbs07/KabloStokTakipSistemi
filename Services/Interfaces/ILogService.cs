...
namespace KabloStokTakipSistemi.Services.Interfaces
{
    public interface ILogService
    {
        ...
        Task<IReadOnlyList<LogStatDto>> GetCountByOperationAsync(DateTime? from = null, DateTime? to = null, CancellationToken ct = default);
        Task<IReadOnlyList<LogStatDto>> GetCountByTableAsync(DateTime? from = null, DateTime? to = null, CancellationToken ct = default);
